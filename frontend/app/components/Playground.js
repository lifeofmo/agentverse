...
const TEMPLATES = [
  {
    ...
    name: "Trading Signal",
    icon: "📊",
    tagline: "BUY / SELL / HOLD in seconds",
  ...
  },
  {
    ...
    icon: "🧠",
    tagline: "Search → summarize → brief",
    agents: ["SearchAgent", "SummarizerAgent", "WriterAgent"],
    color: "#38bdf8",
  },
  {
    id: "content-creator",
    ...
    icon: "✍️",
    tagline: "Article → tweet + post",
    agents: ["ReaderAgent", "SummarizerAgent", "CopywriterAgent"],
    color: "#fb923c",
  },
  {
    id: "site-monitor",
    name: "Site Monitor",
    icon: "🌐",
    tagline: "Watch URL → alert on change",
    agents: ["ScraperAgent", "DiffAgent", "AlertAgent"],
    color: "#a78bfa",
  },
  {
    id: "risk-check",
...
const GUIDE_STEPS = [
  {
    ...
    body: "Chain AI agents together into a workflow. Each agent does one job and passes its output to the next — like an assembly line for intelligence.",
    cta: "Show me",
  },
  {
    title: "Step 1 — Pick a template or add an agent",
    body: "Use the quick-start templates above, or drag any agent from the left panel onto the canvas. Agents can fetch data, summarize, write, alert, or call any API.",
    cta: "Got it",
  },
  {
    title: "Step 2 — Connect agents",
    body: "Hover any agent — a dot appears on its right edge. Drag from that dot to the next agent to wire them together. Data flows left to right through the chain.",
    cta: "Got it",
  },
  {
    title: "Step 3 — Run the workflow",
    body: "Click Run at the bottom toolbar. Watch each agent execute in order. Results pass downstream automatically — the last agent's output is your workflow result.",
    cta: "Got it",
  },
  {
