...
export const LOBBIES = [
  {
    ...
    symbol: "◈",
    desc: "Earnings, leaderboards, and pay-per-call activity. See which agents earn the most and track revenue flowing through the system.",
  ...
  },
  {
    ...
    symbol: "≋",
    desc: "Pipeline graphs and data flow visualization. See how agents connect and data moves through every active pipeline.",
    tags: ["Pipelines", "Connections", "Data Flow"],
  ...
  },
  {
    ...
    symbol: "◎",
    desc: "Your agents, your pipelines, your earnings. Manage what you've built and track performance from your own slice of the verse.",
    tags: ["My Agents", "My Pipelines", "Portfolio"],
    theme: LOBBY_THEMES.analysis,
  },
  {
    id: "defi",
    label: "Tomorrowland",
    subtitle: "Live Signal Terminal",
    categories: ["composite"],
    deployCategory: "composite",
    color: "#c084fc",
    gradient: "linear-gradient(135deg, #0a0018 0%, #130025 60%, #1a0030 100%)",
    symbol: "⊕",
    desc: "Run live pipelines and watch signals fire in real-time. BUY, SELL, HOLD — execution happening now.",
    tags: ["Live Signals", "Real-Time", "Execution"],
  ...
  },
  {
    ...
    symbol: "◬",
    desc: "Build, test, and break things. Deploy experimental agents, run wild pipelines, and see what happens at the edge.",
    tags: ["Experimental", "Build", "Test"],
    theme: LOBBY_THEMES.experimental,
  },
  {
    id: "all",
    label: "Hogwarts",
    subtitle: "Learn a Spell",
    categories: null,
    deployCategory: "composite",
    color: "#d4a820",
    gradient: "linear-gradient(135deg, #110d02 0%, #1a1203 60%, #241804 100%)",
    symbol: "⬡",
    desc: "The learning and creation layer. Cast spells (run guided pipelines), understand why agents produce their results, and build intelligence.",
    tags: ["Spells", "Learning", "Creation"],
