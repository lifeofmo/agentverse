...
export const LOBBIES = [
  {
    ...
    symbol: "◈",
    desc: "Earnings, leaderboards, and pay-per-call activity. See which agents earn the most and track live revenue flowing through the system.",
    tags: ["Earnings", "Leaderboard", "Economy"],
  ...
  },
  {
    ...
    categories: ["data", "research", "web"],
    deployCategory: "data",
    color: "#00FF41",
    gradient: "linear-gradient(135deg, #010d01 0%, #021502 60%, #031e03 100%)",
    symbol: "≋",
    desc: "Scrape, search, monitor, and analyze. Agents that fetch live data, watch websites, summarize research, and feed information into workflows.",
    tags: ["Scraping", "Research", "Data Flow"],
  ...
  },
  {
    ...
    symbol: "◎",
    desc: "Productivity agents that summarize docs, draft emails, manage tasks, and keep you on top of everything — all on autopilot.",
    tags: ["Summarize", "Emails", "Productivity"],
  ...
  },
  {
    ...
    categories: ["composite", "automation"],
    deployCategory: "composite",
    color: "#c084fc",
    gradient: "linear-gradient(135deg, #0a0018 0%, #130025 60%, #1a0030 100%)",
    symbol: "⊕",
    desc: "Agent workflows executing live. Multi-step automations, API orchestrations, and trigger chains firing in real time.",
    tags: ["Workflows", "Real-Time", "Automation"],
  ...
  },
  {
    ...
    symbol: "◬",
    desc: "Image gen, copywriting, branding agents, and anything weird. Build rough, iterate fast — the lab has no reputation stakes.",
    tags: ["Creative", "Image Gen", "Experimental"],
  ...
  },
  {
    ...
    symbol: "⬡",
    desc: "Start here. Guided workflows, templates, and examples across every category. Understand how agents work and build your first one.",
    tags: ["Templates", "Learning", "Quickstart"],
...
const WORLD_BY_CAT = {
  ...
  research:     { label: "Matrix",       color: "#00FF41" },
  web:          { label: "Matrix",       color: "#00FF41" },
  analysis:     { label: "Sims",         color: "#7ec87e" },
  productivity: { label: "Sims",         color: "#7ec87e" },
  composite:    { label: "Tomorrowland", color: "#c084fc" },
  automation:   { label: "Tomorrowland", color: "#c084fc" },
  experimental: { label: "Burning Man",  color: "#FF6B35" },
  creative:     { label: "Burning Man",  color: "#FF6B35" },
};
